...
\oldtext{LSST will also provide an alert filtering service with more limited capability and capacity.}
...
LSST will itself offer an alert filtering service \newtext{of more limited capacity} that will apply user-supplied filters to the alert stream.
...
Throughout the document, we provide references to the formal LSST requirements and \newtext{relevant} design documents as an aid to the interested reader.
