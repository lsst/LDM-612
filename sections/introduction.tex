...
An LSST science user will be able to use the contents of a single alert packet and make a rapid but informed decision about whether the event is relevant to their scientific goals.
