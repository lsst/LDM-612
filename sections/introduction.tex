...
LSST expects to produce up to about ten million of these alerts nightly\footnote{Transients in the alert stream are required to be 90\% complete and 95\% pure at 6$\sigma$ \citeds{LSE-30}, so less than 5\% of the alert stream will consist of false positives.}.
