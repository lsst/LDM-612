...
LSST will provide a threshold that may be used to filter transients in the alert stream to 90\% completeness and 95\% purity at 6$\sigma$ \citeds{LSE-30}, so less than 5\% of alerts filtered in this manner will be artifacts.
