...
The LSST Science Platform (LSP) is described in full in \citeds{LSE-319} and \citeds{LDM-554}. It will serve as a portal to the data, toolkit for analysis, and processing power. The most relevant for brokers is probably web application programming interface (API). 
