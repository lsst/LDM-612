...
AP will process all standard and alternative standard visits, whether obtained as part of the main wide-fast-deep survey or a Special Program \citedsp{DMTN-065} and generate alerts within the required 60 seconds after the \oldtext{shutter closes}\newtext{camera readout completes} (DMS-REQ-0004, \citeds{LSE-61})\footnote{
