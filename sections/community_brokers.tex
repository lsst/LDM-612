...
Evaluation of LOIs will use the same criteria as the full proposals (see below).
In general we expect that all credible LOIs will be invited to submit full proposals.
...
To maximize scientific returns, the panel will make a final selection of an ensemble of complimentary brokers rather than attempting to strictly rank disparate proposals.   
Accordingly the final selection may include lower-ranked proposals if they provide capabilities not present in the top-ranked brokers or serve other scientific communities.
