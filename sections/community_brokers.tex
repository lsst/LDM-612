...
\begin{itemize}
	...
	\item \oldtext{Appropriate personnel to develop and maintain the service} \newtext{Appropriate personnel and sufficient effort to develop the required software and to maintain and operate the service}
...
The broker selection panel will evaluate proposals with a primary goal of maximizing the scientific \oldtext{utilization} \newtext{exploitation} of LSST---recognizing that many of LSST's scientific returns are likely to be unanticipated.
...
\newtext{The timeline presented below is the current best estimate based on the LSST project schedule and is subject to revision.}
\textbf{ERIC: add estimates of the expected quarter to the timeline. }
{
...
\begin{enumerate}
  \setcounter{enumi}{2017}
	...
	\item \begin{itemize}% 2019
		...
		\item \newtext{Letters of intent due (ERIC: move this to the appropriate place w.r.t the other items. }
...
\newtext{The production of sample commissioning alerts with ComCam is dependent on the ComCam commissioning schedule and progress; any delays in ComCam will have a knock-on effect on the Broker development.} 
