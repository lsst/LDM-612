...
LOIs \oldtext{will be}\newtext{were} evaluated using the same criteria as the full proposals (\S \ref{sec:resources}--\ref{sec:evaluation}), with recognition that the proposed brokers may be in the conceptual or early design stage at the time of the LOI.
...
\newtext{At least one broker that provides public access to alerts will be selected.}
...
\newtext{\textbf{updated timeline with estimates of DPs, commissioning,  LOY1 ...  Cite LSO-011.}}
