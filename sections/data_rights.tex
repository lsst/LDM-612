...
The proposed LSST data rights and data access policies (DAPOLs) are formally described in \citeds{LPM-261}. Here we summarize the aspects most relevant to the alert stream. The interested reader is advised to consult \citeds{LPM-261} for details.
